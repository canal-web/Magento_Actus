 ...
 */
class Canalweb_Actus_Model_Actu_Comment extends Mage_Core_Model_Abstract
{
     ...
     */
    const ENTITY    = 'canalweb_actus_actu_comment';
    const CACHE_TAG = 'canalweb_actus_actu_comment';
    /**
     * Prefix of model events names
     * @var string
     */
    protected $_eventPrefix = 'canalweb_actus_actu_comment';
