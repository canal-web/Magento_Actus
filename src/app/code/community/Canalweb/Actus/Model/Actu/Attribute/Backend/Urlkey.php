 ...
 */
class Canalweb_Actus_Model_Actu_Attribute_Backend_Urlkey extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    /**
     * Before save
     *
     ...
     * @return Canalweb_Actus_Model_Actu_Attribute_Backend_Urlkey
     * @author Ultimate Module Creator
     */
    public function beforeSave($object)
    {
        ...
        $validKey = false;
        while (!$validKey) {
            $entityId = Mage::getResourceModel('canalweb_actus/actu')
