 ...
 */
/**
 * Actu comments resource collection model
 *
 * @category    Canalweb
 * @package     Canalweb_Actus
 * @author      Ultimate Module Creator
 */
class Canalweb_Actus_Model_Resource_Actu_Comment_Actu_Collection extends Canalweb_Actus_Model_Resource_Actu_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('canalweb_actus/actu_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.actu_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('canalweb_actus/actu_comment');
        $this->addAttributeToSelect('title');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.actu_id = e.entity_id',
            array(
                'ct_title'      => 'title',
