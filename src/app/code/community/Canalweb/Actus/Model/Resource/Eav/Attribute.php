 ...
 */
class Canalweb_Actus_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const MODULE_NAME   = 'Canalweb_Actus';
    const ENTITY        = 'canalweb_actus_eav_attribute';

    protected $_eventPrefix = 'canalweb_actus_entity_attribute';
    ...
    {
        $this->_init('canalweb_actus/attribute');
    }
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('canalweb_actus')->__('This attribute is not deletable')
            );
        }
