 ...
 */
class Canalweb_Actus_Block_Adminhtml_Actus_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('canalweb_actus/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Canalweb_Actus_Model_Resource_Eav_Attribute
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @return Canalweb_Actus_Block_Adminhtml_Actus_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('canalweb_actus')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('canalweb_actus')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('canalweb_actus')->__('[STORE VIEW]');
        }
        return $html;
    }
